...
class Ui_gibsoncloneDialog(object):
    def setupUi(self, gibsoncloneDialog):
        ...
        self.groupBox_4 = QtWidgets.QGroupBox(gibsoncloneDialog)
        ...
        self.gridLayout_9.addWidget(self.groupBox_4, 4, 0, 1, 2)
        ...
        self.gridLayout_9.addWidget(self.checkBoxAll, 1, 0, 1, 1)
        ...
        self.gridLayout_9.addLayout(self.gridLayout, 7, 0, 1, 2)
        ...
        self.gridLayout_9.addWidget(self.groupBox_2, 6, 1, 1, 1)
        ...
        self.gridLayout_9.addLayout(self.horizontalLayout, 8, 1, 1, 1)
        self.selectionTable = QtWidgets.QTableWidget(gibsoncloneDialog)
        self.selectionTable.setMinimumSize(QtCore.QSize(0, 150))
        self.selectionTable.setObjectName("selectionTable")
        self.selectionTable.setColumnCount(0)
        self.selectionTable.setRowCount(0)
        self.gridLayout_9.addWidget(self.selectionTable, 2, 0, 1, 2)
        self.groupBox_5 = QtWidgets.QGroupBox(gibsoncloneDialog)
        font = QtGui.QFont()
        font.setPointSize(15)
        ...
        self.outpath = QtWidgets.QLineEdit(self.groupBox_5)
        self.outpath.setObjectName("outpath")
        self.gridLayout_8.addWidget(self.outpath, 0, 0, 1, 1)
        self.browse = QtWidgets.QPushButton(self.groupBox_5)
        self.browse.setMaximumSize(QtCore.QSize(16777215, 32))
        self.browse.setObjectName("browse")
        self.gridLayout_8.addWidget(self.browse, 0, 1, 1, 1)
        self.gridLayout_9.addWidget(self.groupBox_5, 5, 0, 1, 2)
        ...
        self.gridLayout_9.addWidget(self.groupBox, 6, 0, 1, 1)
        self.groupBox_3 = QtWidgets.QGroupBox(gibsoncloneDialog)
        self.groupBox_3.setMaximumSize(QtCore.QSize(16777215, 2000))
        font = QtGui.QFont()
        font.setPointSize(15)
        ...
        self.jointUP = QtWidgets.QTextEdit(self.groupBox_3)
        self.jointUP.setMaximumSize(QtCore.QSize(16777215, 21))
        self.jointUP.setObjectName("jointUP")
        self.gridLayout_6.addWidget(self.jointUP, 0, 1, 1, 1)
        self.label_5 = QtWidgets.QLabel(self.groupBox_3)
        self.label_5.setObjectName("label_5")
        self.gridLayout_6.addWidget(self.label_5, 1, 0, 1, 1)
        self.jointDOWN = QtWidgets.QTextEdit(self.groupBox_3)
        self.jointDOWN.setMaximumSize(QtCore.QSize(16777215, 21))
        self.jointDOWN.setObjectName("jointDOWN")
        self.gridLayout_6.addWidget(self.jointDOWN, 1, 1, 1, 1)
        self.saveConnector = QtWidgets.QPushButton(self.groupBox_3)
        self.saveConnector.setMaximumSize(QtCore.QSize(120, 16777215))
        self.saveConnector.setLayoutDirection(QtCore.Qt.LeftToRight)
        self.saveConnector.setObjectName("saveConnector")
        self.gridLayout_6.addWidget(self.saveConnector, 2, 0, 1, 1)
        self.CterminalRadioButton = QtWidgets.QRadioButton(self.groupBox_3)
        self.CterminalRadioButton.setObjectName("CterminalRadioButton")
        self.gridLayout_6.addWidget(self.CterminalRadioButton, 2, 1, 1, 1)
        self.Piclabel = QtWidgets.QLabel(self.groupBox_3)
        ...
        self.gridLayout_6.addWidget(self.Piclabel, 3, 0, 1, 2)
        self.label_1h = QtWidgets.QLabel(self.groupBox_3)
        self.label_1h.setObjectName("label_1h")
        self.gridLayout_6.addWidget(self.label_1h, 4, 0, 1, 1)
        self.Trimerization = QtWidgets.QTextEdit(self.groupBox_3)
        self.Trimerization.setMaximumSize(QtCore.QSize(16777215, 21))
        self.Trimerization.setObjectName("Trimerization")
        self.gridLayout_6.addWidget(self.Trimerization, 4, 1, 1, 1)
        self.label_2h = QtWidgets.QLabel(self.groupBox_3)
        self.label_2h.setObjectName("label_2h")
        self.gridLayout_6.addWidget(self.label_2h, 5, 0, 1, 1)
        self.AviTag = QtWidgets.QTextEdit(self.groupBox_3)
        self.AviTag.setMaximumSize(QtCore.QSize(16777215, 21))
        self.AviTag.setObjectName("AviTag")
        self.gridLayout_6.addWidget(self.AviTag, 5, 1, 1, 1)
        self.label_3h = QtWidgets.QLabel(self.groupBox_3)
        self.label_3h.setObjectName("label_3h")
        self.gridLayout_6.addWidget(self.label_3h, 6, 0, 1, 1)
        self.SixHisTag = QtWidgets.QTextEdit(self.groupBox_3)
        self.SixHisTag.setMaximumSize(QtCore.QSize(16777215, 21))
        self.SixHisTag.setObjectName("SixHisTag")
        self.gridLayout_6.addWidget(self.SixHisTag, 6, 1, 1, 1)
    ...
    def retranslateUi(self, gibsoncloneDialog):
        ...
        self.groupBox_4.setTitle(_translate("gibsoncloneDialog", "Fragments Database:"))
        ...
        self.groupBox_5.setTitle(_translate("gibsoncloneDialog", "Gibson clone fragments files output path:"))
        ...
        self.groupBox_3.setTitle(_translate("gibsoncloneDialog", "Vector Connector Sequences"))
        self.label_3.setText(_translate("gibsoncloneDialog", "Gibson cloning upstream:"))
