...
class Ui_GibsonSingleDialog(object):
    def setupUi(self, GibsonSingleDialog):
        ...
        GibsonSingleDialog.resize(1184, 827)
        self.gridLayout_8 = QtWidgets.QGridLayout(GibsonSingleDialog)
        ...
        self.textEdit.setMaximumSize(QtCore.QSize(16777215, 99999))
        font = QtGui.QFont()
        ...
        self.gridLayout_7.addWidget(self.pushButtonGenerate, 1, 1, 1, 1)
        self.gridLayoutFig = QtWidgets.QGridLayout()
        self.gridLayoutFig.setObjectName("gridLayoutFig")
        self.gridLayout_7.addLayout(self.gridLayoutFig, 0, 0, 1, 2)
        ...
        self.gridLayout_8.addWidget(self.pushButtonCancel, 4, 1, 1, 1)
        ...
        self.gridLayout_8.addWidget(self.pushButtonConfirm, 4, 2, 1, 1)
        ...
        self.gridLayout_8.addWidget(self.groupBox, 3, 0, 1, 3)
        ...
        self.gridLayout_8.addWidget(self.frame, 0, 0, 1, 3)
