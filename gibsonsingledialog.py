...
class Ui_GibsonSingleDialog(object):
    def setupUi(self, GibsonSingleDialog):
        ...
        self.gridLayout_5.addWidget(self.pushButtonBrowse, 1, 2, 1, 1)
        self.label_3 = QtWidgets.QLabel(self.groupBox)
        self.label_3.setObjectName("label_3")
        self.gridLayout_5.addWidget(self.label_3, 1, 0, 1, 1)
        self.outpath = QtWidgets.QLineEdit(self.groupBox)
        self.outpath.setObjectName("outpath")
        self.gridLayout_5.addWidget(self.outpath, 1, 1, 1, 1)
