...
class Ui_GibsonSingleDialog(object):
    def setupUi(self, GibsonSingleDialog):
        ...
        GibsonSingleDialog.resize(1108, 721)
        ...
        self.tabWidget_2.setMaximumSize(QtCore.QSize(16777215, 120))
        ...
        spacerItem2 = QtWidgets.QSpacerItem(905, 20, QtWidgets.QSizePolicy.Expanding, QtWidgets.QSizePolicy.Minimum)
    ...
    def retranslateUi(self, GibsonSingleDialog):
        ...
        self.tabWidget_2.setTabText(self.tabWidget_2.indexOf(self.tab_3), _translate("GibsonSingleDialog", "Loacl DB"))
        ...
        self.tabWidget_2.setTabText(self.tabWidget_2.indexOf(self.tab_4), _translate("GibsonSingleDialog", "Remote DB"))
