...
class Ui_SequenceEditDialog(object):
    def setupUi(self, SequenceEditDialog):
        ...
        self.label_tab1_2 = QtWidgets.QLabel(self.tab)
        self.label_tab1_2.setGeometry(QtCore.QRect(10, 240, 581, 16))
        self.label_tab1_2.setObjectName("label_tab1_2")
        self.label_tab1_3 = QtWidgets.QLabel(self.tab)
        self.label_tab1_3.setGeometry(QtCore.QRect(20, 270, 71, 31))
        self.label_tab1_3.setObjectName("label_tab1_3")
        self.label_tab1_4 = QtWidgets.QLabel(self.tab)
        self.label_tab1_4.setGeometry(QtCore.QRect(340, 270, 71, 31))
        self.label_tab1_4.setObjectName("label_tab1_4")
        self.DonorFrom = QtWidgets.QLineEdit(self.tab)
        self.DonorFrom.setGeometry(QtCore.QRect(70, 270, 251, 31))
        self.DonorFrom.setObjectName("DonorFrom")
        self.DonorTo = QtWidgets.QLineEdit(self.tab)
        self.DonorTo.setGeometry(QtCore.QRect(370, 270, 251, 31))
        self.DonorTo.setObjectName("DonorTo")
        ...
        self.DonorList_tab2.setGeometry(QtCore.QRect(10, 40, 611, 271))
        ...
        self.DonorList_tab3.setGeometry(QtCore.QRect(10, 40, 611, 271))
        ...
        self.DonorList_tab4.setGeometry(QtCore.QRect(10, 40, 611, 271))
    ...
    def retranslateUi(self, SequenceEditDialog):
        ...
        self.label_tab1_2.setText(_translate("SequenceEditDialog", "Please select donor region:"))
        self.label_tab1_3.setText(_translate("SequenceEditDialog", "From:"))
        self.label_tab1_4.setText(_translate("SequenceEditDialog", "To:"))
