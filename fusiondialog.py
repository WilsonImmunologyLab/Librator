...
class Ui_fusionDialog(object):
    def setupUi(self, fusionDialog):
        ...
        fusionDialog.resize(708, 533)
        self.horizontalLayoutWidget = QtWidgets.QWidget(fusionDialog)
        self.horizontalLayoutWidget.setGeometry(QtCore.QRect(30, 479, 651, 32))
        ...
        self.selection.setGeometry(QtCore.QRect(30, 50, 651, 181))
    ...
    def retranslateUi(self, fusionDialog):
        ...
        fusionDialog.setWindowTitle(_translate("fusionDialog", "Dialog"))
