...
class Ui_UpdateSequenceDialog(object):
    def setupUi(self, UpdateSequenceDialog):
        ...
        self.gridLayout.addWidget(self.textEditAA, 7, 0, 1, 2)
        ...
        self.pushButtonCheck = QtWidgets.QPushButton(UpdateSequenceDialog)
        self.pushButtonCheck.setObjectName("pushButtonCheck")
        self.gridLayout.addWidget(self.pushButtonCheck, 3, 0, 1, 1)
    ...
    def retranslateUi(self, UpdateSequenceDialog):
        ...
        self.label_5.setText(_translate("UpdateSequenceDialog", "Coding Region (Gray)       From:"))
        self.label_6.setText(_translate("UpdateSequenceDialog", "To:"))
        self.pushButtonCheck.setText(_translate("UpdateSequenceDialog", "Check Seq"))
